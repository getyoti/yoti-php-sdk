...
* Authentication credentials - either:
  * Your .pem file (traditional method) - Your unique private key generated from the [Yoti Hub](https://hub.yoti.com) when you create an application.
  * An authentication token (Central Auth) - For token-based authentication.

For more details about authentication options, see the [Authentication Guide](/docs/AUTHENTICATION.md).
...
1) [Authentication](/docs/AUTHENTICATION.md) - Guide to authentication methods and configuration.
