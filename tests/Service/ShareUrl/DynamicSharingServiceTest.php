...
/**
 * @coversDefaultClass \Yoti\Service\ShareUrl\DynamicSharingService
 */
class DynamicSharingServiceTest extends TestCase
{
    /**
    ...
    public function testCreateShareUrl()
    {
        ...
        $dynamicSharingService = new DynamicSharingService(new Config([
            Config::HTTP_CLIENT => $httpClient,
        ]));

        $shareUrlResult = $dynamicSharingService->createShareUrl(
            $dynamicScenario,
    ...
    public function testCreateShareUrlFailure($statusCode)
    {
        ...
        $yotiClient = $this->createDynamicSharingServiceWithErrorResponse($statusCode);
     ...
     */
    private function createDynamicSharingServiceWithErrorResponse($statusCode)
    {
        $response = $this->createMock(ResponseInterface::class);
        ...
        return new DynamicSharingService(new Config([
            Config::HTTP_CLIENT => $httpClient,
        ]));
    }
}
