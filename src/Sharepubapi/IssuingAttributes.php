...
class IssuingAttributes extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Sharepubapi\Definition[]|\Google\Protobuf\Internal\RepeatedField $definitions
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .sharepubapi_v1.Definition definitions = 2;</code>
     * @param \Sharepubapi\Definition[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDefinitions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Sharepubapi\Definition::class);
