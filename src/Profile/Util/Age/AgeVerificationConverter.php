...
class AgeVerificationConverter
{
    ...
    public function getAgeVerificationsFromAttrsMap()
    {
        ...
        foreach ($this->profileAttributesMap as $attrName => $attributeObj) {
            foreach ($this->getAgeProcessors() as $ageProcessorClass) {
                $abstractAgeProcessorClass = AbstractAgeProcessor::class;
                if (
                    null !== $attrName
                    && null !== $attributeObj
                    ...
                    /**
                     * @var \Yoti\Profile\Util\Age\AbstractAgeProcessor $ageProcessorObj
                     */
    ...
    {
        return [
            AgeUnderVerificationProcessor::class,
            AgeOverVerificationProcessor::class,
        ];
    }
}
